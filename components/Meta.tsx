...
const Meta = (props: Props) => {
  ...
  const title = 'Charity | Ahmed Ibrahim'
  ...
  return (
    <Head>
      ...
      <meta
        name="keywords"
        content="ahmedibra, ahmedibra.com, https://ahmedibra.com, https://github.com/ahmaat19, github.com/ahmaat19, next.js, next-ts, typescript, next-typescript, charity, nextjs-charity, next-charity, next.js-charity"
      />
